    ...
    private void bindData(int itemViewType, ViewHolder viewHolder, NetAudioPagerData.ListEntity mediaItem) {
        switch (itemViewType) {
            case TYPE_VIDEO://视频
                ...
                //原始的
//                viewHolder.jcv_videoplayer.setUp(mediaItem.getVideo().getVideo().get(0), mediaItem.getVideo().getThumbnail().get(0),JZVideoPlayerStandard.SCREEN_WINDOW_NORMAL,"");
                viewHolder.jcv_videoplayer.setUp(mediaItem.getVideo().getVideo().get(0), JZVideoPlayerStandard.SCREEN_WINDOW_NORMAL, "");
    ...
    private View initView(View convertView, int itemViewType, ViewHolder viewHolder) {
        switch (itemViewType) {
            case TYPE_VIDEO://视频
                ...
                viewHolder.jcv_videoplayer = (JZVideoPlayerStandard) convertView.findViewById(R.id.jcv_videoplayer);
                break;
            case TYPE_IMAGE://图片
